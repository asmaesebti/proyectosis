...
<body>
	<div class="container">
		<h1 class="mt-4 d-flex justify-content-center align-content-center">Envoyer un email</h1>
		<form name="form1" enctype="multipart/form-data" method="post" action="enviarMailConFIcheroAdjunto.php" id="application-form" class="form">
			...
			<div class="row clearfix d-flex justify-content-center">
				<div class="col-md-8 col-sm-12 col-xs-12 mt-3">
					<div class="form-group">
						...
						<input type="text" value="<?php echo $nombre; ?>" placeholder="Introduir içi votre nom complet"  name="name" required class="form-control shadow p-3 mt-3 bg-body rounded">
					</div>
					<div class="form-group mt-3">
						<label class="form-label">Email Client</label>
						<input type="email" value="<?php echo $email; ?>" placeholder="Introduir içi votre Email " name="email" required class="form-control shadow p-3 mt-3 bg-body rounded">
					</div>
					<div class="form-group mt-3">
						<label class="form-label">Telephone Client</label>
						<input type="phone" value="<?php echo $telefono; ?>" placeholder="Introduir içi votre telephone" name="phone" required class="form-control shadow p-3 mt-3 bg-body rounded">
					</div>
				...
				<div class="col-md-8 col-sm-12 col-xs-12 mt-3">
					<div class="form-group">
						...
						<textarea name="message" placeholder="Introduir içi votre message" class="form-control shadow p-3 mt-3 bg-body rounded" required></textarea>
					</div>
				</div>
			...
			<div class="form-group mt-4 mb-4 d-flex justify-content-center">
				<a href="../index.php"   class="theme-btn dark-btn hvr-bounce-to-right btn btn-warning me-5 " name="volver">
					<span class="fa fa-arrow-left"></span> Retour </a>
					<button type="submit"  class="theme-btn dark-btn hvr-bounce-to-right btn btn-primary " name="enviar">
						<span class="fa fa-envelope"></span> Envoyer email </button>
						<button type="reset"  class="theme-btn dark-btn hvr-bounce-to-right btn btn-danger ms-5 " name="reset">
							<span class="fa fa-undo"></span> vider les champs </button>
						</div>
					</form>
				</div>
