...
// config document
$pdf->SetTitle(utf8_decode('Le relevé de l`assuré'));
...
$pdf->MultiCell(0, 7, utf8_decode("RELEVÉ"), 0, 1);
...
$pdf->Cell( $celda_35, 21, utf8_decode( $array[ 'police' ] ) , 1, 0, 'C' );
...
/* Output the string at the required font size */
$pdf->Cell( $celda_20, 21, utf8_decode( $array["totale"]) , 1, 0, 'C' );
/* Return the font size to itś original */
...
/* Output the string at the required font size */
$pdf->Cell( $celda_75, 7, utf8_decode( "Total Primes") , 1, 0, 'C' );
/* Return the font size to itś original */
...
/* Output the string at the required font size */
$pdf->Cell( $celda_35, 7, utf8_decode( $array["prime_net"]) , 1, 0, 'C' );
/* Return the font size to itś original */
...
/* Output the string at the required font size */
$pdf->Cell( $celda_75, 7, utf8_decode( "Total Taxes") , 1, 0, 'C' );
/* Return the font size to itś original */
...
/* Output the string at the required font size */
$pdf->Cell( $celda_35, 7, utf8_decode( $array["taxes"]) , 1, 0, 'C' );
/* Return the font size to itś original */
...
/* Output the string at the required font size */
$pdf->Cell( $celda_75, 7, utf8_decode( "Total Timbres & Accessoires") , 1, 0, 'C' );
/* Return the font size to itś original */
...
/* Output the string at the required font size */
$pdf->Cell( $celda_35, 7, utf8_decode( $array["accesoires"]) , 1, 0, 'C' );
/* Return the font size to itś original */
...
/* Output the string at the required font size */
$pdf->Cell( $celda_75, 7, utf8_decode( "Total TTC") , 1, 0, 'C' );
/* Return the font size to itś original */
$pdf->SetFont( 'Arial', 'B', $g11 );
...
/* Output the string at the required font size */
$pdf->Cell( $celda_35, 7, utf8_decode( $array["totale"]) , 1, 0, 'C' );
/* Return the font size to itś original */
$pdf->SetFont( 'Arial', 'B', $h11 );
