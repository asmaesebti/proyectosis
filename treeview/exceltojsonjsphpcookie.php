        ...
        try {
          ...
          reader.onload = function(e) {
            ...
            const a =  d.getTime();
                ...
                var myObject = JSON.parse(resultEle.value);
             //   document.cookie = "username=" + resultEle.value ;
                document.cookie = 'username1='+ JSON.stringify(myObject);
   ...
   //echo $_COOKIE['micookie'];
     // setcookie("micookie1", "moha2");
      ...
      if (!isset($_COOKIE['username1'])) {
       ...
       $d = $_COOKIE['username1'];
       $data = json_encode($d);
       $path = 'C:\Users\daw2\Desktop\mijons\json'.$mytime["sec"].'.txt';
